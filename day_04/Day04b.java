...
class Day04b {
    ...
    public void run() {
        ...
        for (int i = 0; i < numbers.length; i++) {
            ...
            if (i >= 5) {
                System.out.println("numbers="+tempNumbers.size()+" board count="+boards.size());
                ...
                for (int j = 0; j < boards.size(); j++) {
                    ...
                    if (isWinningBoard(board, tempNumbers)) {
                        ...
                        boardsToRemove.add(Integer.valueOf(j));
                    }
                }
                for (int j = boardsToRemove.size() - 1; j >= 0; j--) {
                    Integer boardToRemove = boardsToRemove.get(j);
                    System.out.println("Removing board " + boardToRemove);
                    boards.remove(boardToRemove.intValue());
                }
            }
